<template>
    <div>
        <ul>
            ...
            <li v-for="n in totalTopics" :key="n" @click="select(n)" :class="{ active: current == n-1 }">
                <!-- <button class="{ active: current === n }" type="button">{{n}}</button> -->
                {{ n }}
            </li>

            <!-- <li v-for="n in pages" :key="n" @click="switchPage(n)" :class="{ active: currentPage == n }">
                {{ n }}
            </li> -->
            
            <!-- <li v-if="current < totalTopics - 2">...</li> -->
...
<script>
    export default {
        ...
        methods: {
            ...
            go(n) {
                // 前进
                if (n == 1 && this.current < this.totalTopics) {
                    this.current++
